...
import com.example.findit.ui.components.BrandWaveHeader
 ...
 * Keep this screen for later Figma / copy tweaks; do not wire it in FindItNavHost until needed.
 */
@Deprecated(
                    ...
                    modifier = Modifier
                        ...
                        .background(
                            brush = Brush.radialGradient(
                                colors = listOf(
                                    FindItBlueLight.copy(alpha = 0.9f),
                                    Color.Transparent
                                )
                            ),
...
private fun FeatureColumn(
    ...
    Column(
        ...
        Box(
            modifier = Modifier
                .size(48.dp)
                .background(FindItBlueLight, RoundedCornerShape(14.dp)),
            contentAlignment = Alignment.Center
        ) {
            Icon(
                imageVector = icon,
